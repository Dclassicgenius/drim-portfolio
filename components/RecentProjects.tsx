...
const RecentProjects = () => {
  return (
    <div id="projects" className="py-20">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-32">
        {projects.map((item) => (
          <div
            className="sm:h-[36rem] h-[32rem] lg:min-h-[32.5rem]flex items-center justify-center sm:w-[570px] w-[80vw]"
            key={item.id}
          >
