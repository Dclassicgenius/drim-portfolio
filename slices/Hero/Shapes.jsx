...
export function Shapes() {
  return (
    <div className="row-span-1 row-start-1 -mt-[140px] aspect-square  md:col-span-1 md:col-start-2 md:mt-0">
      <Canvas
        className="z-0"
        shadows
        gl={{ antialias: false }}
...
function Geometries() {
  const geometries = [
    ...
    },
    {
      position: [1.6, 1.6, -4],
      r: 0.7,
      geometry: new THREE.TorusKnotGeometry(), // knot
    },
    {
      position: [-0.8, -0.75, 5],
      r: 0.5,
      ...
      //   new THREE.SphereGeometry(),s // sphere
    },
  ];
